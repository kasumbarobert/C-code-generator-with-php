...
--
-- Host: localhost
-- Generation Time: Jul 16, 2016 at 02:44 
...
('Robert', '1990-03-23', 'roberts', '21407893638', 'Student', '34b073c48f650e2d1e9d51d1e57b0a6a', 0);
...
--
ALTER TABLE `cases`
  ADD PRIMARY KEY (`case_Value`,`attached_Switch`),
  ADD KEY `attached_Switch` (`attached_Switch`);

--
-- Indexes for table `login`
--
ALTER TABLE `login`
  ADD PRIMARY KEY (`Time_Logged_In`,`Date`,` Username`),
...
--
ALTER TABLE `logs`
  ADD PRIMARY KEY (`SectionName`,`Solution_ID`),
...
ALTER TABLE `newaccount`
  ...
  ADD UNIQUE KEY `IdentificationNumber_2` (`IdentificationNumber`),
  ADD KEY `IdentificationNumber` (`IdentificationNumber`);
...
ALTER TABLE `solution`
  ...
  ADD UNIQUE KEY `solution_id` (`solution_id`),
...
ALTER TABLE `switch`
  ADD PRIMARY KEY (`id`),
  ADD KEY `attached_Section` (`attached_Section`);

--
-- Indexes for table `variable`
--
ALTER TABLE `variable`
  ADD PRIMARY KEY (`variableName`,`variableType`,`variableScope`,`sectionName`,`solution_id`),
